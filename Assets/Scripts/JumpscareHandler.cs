...
// JumpscareHandler.cs - Manages jumpscare effect and game over
using UnityEngine;
using UnityEngine.SceneManagement;

public class JumpscareHandler : MonoBehaviour
{
    public GameObject jumpscareImage; // UI image to display jumpscare
    public float jumpscareDuration = 2f;

    public void TriggerJumpscare()
    {
        jumpscareImage.SetActive(true);
        Invoke("GameOver", jumpscareDuration);
    }
